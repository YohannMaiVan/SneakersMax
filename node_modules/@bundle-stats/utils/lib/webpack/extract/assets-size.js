...
var _fileTypes2 = require("../../utils/file-types");
...
const calculateTotalByType = assets => assets.reduce((accumulator, current) => {
  const fileType = (0, _fileTypes2.getFileType)(current.name);
...
const getFilterInitialAssetsByType = fileType => ({
  name,
  isInitial
}) => (0, _fileTypes2.getFileType)(name) === fileType && isInitial; // eslint-disable-line implicit-arrow-linebreak
