...
export var filtersDropdownContainer = function filtersDropdownContainer(BaseComponent) {
  var FiltersDropdownContainer = /*#__PURE__*/function (_React$Component) {
    _inheritsLoose(FiltersDropdownContainer, _React$Component);

    function FiltersDropdownContainer(props) {
      var _this;
    ...
    FiltersDropdownContainer.getDerivedStateFromProps = function getDerivedStateFromProps(_ref4, state) {
    ...
    var _proto = FiltersDropdownContainer.prototype;
