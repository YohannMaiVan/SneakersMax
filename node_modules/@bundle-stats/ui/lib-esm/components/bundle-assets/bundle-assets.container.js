...
export var enhance = compose(withProps(function (_ref3) {
  ...
  var emptyFilters = _objectSpread(_objectSpread((_objectSpread3 = {}, _objectSpread3[ASSET_FILTERS.CHANGED] = false, _objectSpread3), getAssetEntryTypeFilters(false)), getAssetFileTypeFilters(false));

  var allEntriesFilters = _objectSpread(_objectSpread((_objectSpread4 = {}, _objectSpread4[ASSET_FILTERS.CHANGED] = false, _objectSpread4), getAssetEntryTypeFilters(true)), getAssetFileTypeFilters(true));
