...
var filtersDropdownContainer = function filtersDropdownContainer(BaseComponent) {
  var FiltersDropdownContainer = /*#__PURE__*/function (_React$Component) {
    _inherits(FiltersDropdownContainer, _React$Component);

    var _super = _createSuper(FiltersDropdownContainer);

    function FiltersDropdownContainer(props) {
      var _this;

      _classCallCheck(this, FiltersDropdownContainer);
    ...
    _createClass(FiltersDropdownContainer, [{
      key: "render",
